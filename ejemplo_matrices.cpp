...
int main(int argc, char** argv) {
    ...
    if(rank==0){
        ...
        std::printf(
            "Dimension: %d, rows_alloc: %d, rows_per_rank: %d, padding: %d\n",
        ...
        matrix_mult(A.data(),b.data(),rows_per_rank,MATRIX_DIMENSION);
        ...
        //recivir matriz A
        MPI_Scatter(nullptr,0,MPI_DOUBLE,A_local.data(), MATRIX_DIMENSION*rows_per_rank,
        ...
        matrix_mult(A_local.data(),b_local.data(),c_local.data(),rows_per_rank_tmp);
